...
6. **Select model and mode.** Use public Xiaoyunque model labels as UI-facing names. Default to `Seedance 2.0 Fast` for general cost/speed balance unless the user specifies VIP, Mini, direct/full, or Seedance 1.5.
